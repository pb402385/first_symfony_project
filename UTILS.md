## Ce fichier est mon ancien README.md, c'est juste des notes que j'ai écrit durant mon apprentissage de PHP Symfony, le mieux c'est de se réferrer au nouveau README.md désormais!
